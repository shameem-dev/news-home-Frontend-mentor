...
function App() {
  ...
  return (
    <>
    <div className='px-8  bg-slate-100 relative'>
    {isOpen && (
            <div className=' origin-top-right right-0 shadow bg-white w-60 h-screen justify-center fixed'>
                
                    <div className='text-blue-950 text-2xl font-semibold  pl-8 flex  flex-col justify-between mt-24'>
                        <div className='py-4'><a href="#home">Home</a></div>
                        <div className='py-4'><a href="#new">New</a></div>
                        <div className='py-4'><a href="#">Popular</a></div>
                        <div className='py-4'><a href="#">Trending</a></div>
                        <div className='py-4'><a href="#cat">Categories</a></div>
                    </div>
                

                <div className='absolute  top-3 right-2' onClick={toggleClose} >               
                        <img src="data:image/png;base64,"></img>
                    </div>
      ...
      {/* NavBar */}
        <div  className='flex justify-between items-center pt-8' id='home'>
            <div >
            ...
            <div className='pt-4' onClick={toggleMenu}>
        ...
        <div>
            ...
            <div className='my-6'>
                ...
                <div>
                    ...
                    <p className='text-lg text-gray-900 mb-4'>We dive into the next evolution of the web that claims to put the power of the platforms back into the hands of the people. 
                    But is it really fulfilling its promise?</p>


                    <button className='bg-red-400 px-6 py-2 text-xl text-blue-950 font-bold tracking-widest hover:text-white hover:bg-black'>READ MORE</button>
                </div>
            </div>

        </div>
        <div className='bg-slate-900 p-6 text-white' id='new'>
            <h1 className='text-yellow-600 text-4xl font-extrabold pb-4'>New</h1>
            <div className='my-4'>
                <h4 className='text-xl font-bold hover:text-yellow-500 cursor-pointer'>Hydrogen VS Electric Cars</h4>
                <p className='opacity-85 my-2'>Will hydrogen-fueled cars ever catch up to EVs?</p>
            </div>
            <hr />
            <div className='my-4'>
                <h4 className='text-xl font-bold hover:text-yellow-500 cursor-pointer'>The Downsides of AI Artistry</h4>
                <p className='opacity-85 my-2'> What are the possible adverse effects of on-demand AI image generation?
                </p>
            </div>
            <hr />
            <div className='my-4'>
                <h4 className='text-xl font-bold hover:text-yellow-500 cursor-pointer'>Is VC Funding Drying Up?</h4>
                <p className='opacity-85 my-2'>Private funding by VC firms is down 50% YOY. We take a look at what that means.</p>
            </div>
        </div>

        {/* Numbers category */}
        <div className='my-8' id='cat'>
            <div className='flex my-8'>
                ...
                <div className='flex flex-col justify-between pl-6'>
                    ...
                    <p className='text-gray-600 text-lg font-medium'>What happens when old PCs are given modern upgrades?</p>
                </div>
            </div>
            <div className='flex my-8'>
                <div>
                ...
                <div className='flex flex-col justify-between pl-6'>
                    ...
                    <p className='text-gray-600 text-lg font-medium'>Our best picks for various needs and budgets.</p>
                </div>
            </div>
            <div className='flex my-8'>
                <div>
                ...
                <div className='flex flex-col justify-between pl-6'>
                    ...
                    <p className='text-gray-600 text-lg font-medium'>How the pandemic has sparked fresh opportunities.</p>
                </div>
            </div>
